...
import meteorclient.systems.modules.banana.SurroundPlus;
...
public class BWorldUtils {
    ...
    public static void snapPlayer() {
        BlockPos lastPos = mc.player.isOnGround() ? BWorldUtils.roundBlockPos(mc.player.getPos()) : mc.player.getBlockPos();
        snapPlayer(lastPos);
    }
