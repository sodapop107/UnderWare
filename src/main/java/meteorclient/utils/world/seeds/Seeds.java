package meteorclient.utils.world.seeds;
...
import meteorclient.events.world.SeedChangedEvent;
...
public class Seeds extends System<Seeds> {
    ...
    public void setSeed(String seed, MCVersion version) {
        ...
        UnderWare.EVENT_BUS.post(SeedChangedEvent.get(numSeed));
    }
