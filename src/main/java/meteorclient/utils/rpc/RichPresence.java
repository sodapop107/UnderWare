...
public class RichPresence {
    ...
    private meteordevelopment.RichPresence.Assets assets;
    private meteordevelopment.RichPresence.Timestamps timestamps;
    ...
    public void setLargeImage(String key, String text) {
        if (assets == null) assets = new meteordevelopment.RichPresence.Assets();
    ...
    public void setStart(long time) {
        if (timestamps == null) timestamps = new meteordevelopment.RichPresence.Timestamps();
