...
import meteorclient.utils.rpc.IPCUser;
import meteorclient.utils.rpc.Opcode;
import meteorclient.utils.rpc.Packet;
import meteorclient.utils.rpc.RichPresence;
import meteorclient.utils.rpc.connection.Connection;
...
public class DiscordIPC {
    ...
    private static BiConsumer<Integer, String> onError = meteorclient.utils.rpc.DiscordIPC::defaultErrorCallback;
    ...
    public static void setOnError(BiConsumer<Integer, String> onError) {
        meteorclient.utils.rpc.DiscordIPC.onError = onError;
    }
    ...
    public static boolean start(long appId, Runnable onReady) {
        // Open connection
        c = Connection.open(meteorclient.utils.rpc.DiscordIPC::onPacket);
        if (c == null) return false;

        meteorclient.utils.rpc.DiscordIPC.onReady = onReady;
