...
import meteorclient.gui.DefaultSettingsWidgetFactory;
import meteorclient.gui.GuiTheme;
import meteorclient.gui.WidgetScreen;
import meteorclient.gui.renderer.packer.GuiTexture;
import meteorclient.gui.themes.meteor.widgets.*;
import meteorclient.gui.themes.meteor.widgets.input.WMeteorDropdown;
import meteorclient.gui.themes.meteor.widgets.input.WMeteorSlider;
import meteorclient.gui.themes.meteor.widgets.input.WMeteorTextBox;
import meteorclient.gui.themes.meteor.widgets.pressable.*;
import meteorclient.gui.utils.AlignmentX;
import meteorclient.gui.utils.CharFilter;
import meteorclient.gui.widgets.*;
...
import meteorclient.gui.widgets.input.WSlider;
import meteorclient.gui.widgets.input.WTextBox;
import meteorclient.gui.widgets.pressable.*;
