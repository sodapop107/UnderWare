...
import meteorclient.renderer.Framebuffer;
import meteorclient.renderer.GL;
import meteorclient.renderer.PostProcessRenderer;
import meteorclient.renderer.Shader;
...
public class Blur extends Module {
    ...
    public Blur() {
        ...
        UnderWare.EVENT_BUS.subscribe(new ConsumerListener<>(WindowResizedEvent.class, event -> {
            if (fbo1 != null) {
                fbo1.resize();
                fbo2.resize();
            }
        ...
        UnderWare.EVENT_BUS.subscribe(new ConsumerListener<>(RenderAfterWorldEvent.class, event -> onRenderAfterWorld()));
    }
