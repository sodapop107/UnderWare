...
import meteorclient.utils.world.BlockUtilsWorld;
...
public class AntiBed extends Module {
    ...
    public AntiBed() {
        super(Categories.Combat, "anti-bed", "Places string and breaking beds around you to prevent beds being placed on you.");
    }
