...
@Config(name = "splashscreen")
public class SplashScreenConfig implements ConfigData {
    ...
    @ConfigEntry.Gui.EnumHandler(option = ConfigEntry.Gui.EnumHandler.EnumDisplayOption.BUTTON)
    public ProgressBarMode CProgressBarMode = ProgressBarMode.Linear;

    @Comment(value = "Enable/Disable the custom progress bar background")
    public boolean CProgressBarBackground = false;
    ...
    public static class Textures {
        ...
        public String CBarTexture = "progressbar.png";
        public String CBarBackgroundTexture = "progressbar_background.png";
    }
