...
import meteorclient.utils.network.UnderWareOnlineManager;
...
public class Microsoft {
    ...
    private static JsonArray getXboxToken(String email, String password) throws AuthenticationException {
        ...
        HttpResponse<String> oauthResponse = UnderWareOnlineManager.sendRequest(MS_OAUTH_URL, "GET", null, null, 5000, BodyHandlers.ofString(StandardCharsets.UTF_8));
        ...
        // Login to Microsoft
        HttpResponse<String> loginResponse = UnderWareOnlineManager.sendRequest(
        ...
        HttpResponse<String> redirectResponse = UnderWareOnlineManager.sendRequest(
    ...
    private static Session getSessionFromXsts(String xstsId, String xstsToken) throws AuthenticationException {
        HttpResponse<String> mcResponse = UnderWareOnlineManager.sendRequest(
            MC_AUTH_URL,
            "POST",
            new String[] {
        ...
        HttpResponse<String> profileResponse = UnderWareOnlineManager.sendRequest(
