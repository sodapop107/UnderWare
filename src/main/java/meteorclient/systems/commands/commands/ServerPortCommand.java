...
import meteorclient.utils.network.portscanner.PScanRunner;
import meteorclient.utils.network.portscanner.PortScannerManager;
...
public class ServerPortCommand extends Command {
    ...
    public ServerPortCommand() {
        super("server-port", "Prints server port information");
